...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference("Reminder.count") do
      post reminders_url, params: { reminder: { repeat: @reminder.repeat, time: @reminder.time, title: @reminder.title } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { repeat: @reminder.repeat, time: @reminder.time, title: @reminder.title } }
